  ...
  function handleAddEntry() {
    ...
    if (checkSerialNumberDuplicate(serialNumberVal)) {
      setWarnings({
        ...
        message: `WARNING: Serial No. "${serialNumberVal}" already exists!`,
    ...
    if (checkPropertyNumberDuplicate(propertyNumberVal)) {
      setWarnings({
        ...
        message: `WARNING: Property Number "${propertyNumberVal}" already exists!`,
        action: { confirm: "Understood", cancel: null },
        onConfirm: () => setWarnings({ show: false, type: null, message: "", action: null }),
        onCancel: null
      });
  ...
  function handleSaveEdit() {
    ...
    if (checkSerialNumberDuplicate(editData.serialNumber, editingIndex)) {
      setWarnings({
        show: true,
        type: "duplicate_serial",
        message: `WARNING: Serial No. "${editData.serialNumber}" already exists!`,
        action: { confirm: "Understood", cancel: null },
        onConfirm: () => setWarnings({ show: false, type: null, message: "", action: null }),
        onCancel: null
      });
    ...
    if (checkPropertyNumberDuplicate(editData.propertyNumber, editingIndex)) {
      setWarnings({
        show: true,
        type: "duplicate_property",
        message: `WARNING: Property Number "${editData.propertyNumber}" already exists!`,
        action: { confirm: "Understood", cancel: null },
        onConfirm: () => setWarnings({ show: false, type: null, message: "", action: null }),
        onCancel: null
      });
